...
@Slf4j
public class AuthorizationDataUserCacheKeyGenerator implements KeyGenerator {
    ...
    public Object generate(Object target, Method method, Object... params) {
        ...
        try {
            ...
            String key = (CACHE_KEY_findUserByUserIdAndTokenValue + "%s_%s").formatted(userId, tokenValue);
